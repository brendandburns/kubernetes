...
// strategy implements behavior for Schema objects
type strategy struct {
	runtime.ObjectTyper
	api.NameGenerator
}

// Strategy is the default logic that applies when creating and updating Schema
...
func (strategy) Validate(ctx api.Context, obj runtime.Object) fielderrors.ValidationErrorList {
	return validation.ValidateSchema(obj.(*api.Schema))
}
...
func (strategy) ValidateUpdate(ctx api.Context, obj, old runtime.Object) fielderrors.ValidationErrorList {
	return validation.ValidateSchemaUpdate(old.(*api.Schema), obj.(*api.Schema))
}

// Matcher returns a generic matcher for a given label and field selector.
func Matcher(label labels.Selector, field fields.Selector) generic.Matcher {
	return generic.MatcherFunc(func(obj runtime.Object) (bool, error) {
		sa, ok := obj.(*api.Schema)
		if !ok {
			return false, fmt.Errorf("not a Schema")
		}
...
func SelectableFields(obj *api.Schema) labels.Set {
	return labels.Set{}
}
